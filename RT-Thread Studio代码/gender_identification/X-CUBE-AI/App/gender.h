...
#ifndef __AI_GENDER_H__
#define __AI_GENDER_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_GENDER_MODEL_NAME          "gender"

#define AI_GENDER_ACTIVATIONS_ALIGNMENT   (4)

#define AI_GENDER_IN_NUM       (1)
#define AI_GENDER_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 64, 64, 3, 1, NULL), \
}
#define AI_GENDER_IN_SIZE { \
  (64 * 64 * 3), \
}
#define AI_GENDER_IN_1_SIZE  (64 * 64 * 3)
#define AI_GENDER_IN_1_SIZE_BYTES  ((64 * 64 * 3) * 1)





#define AI_GENDER_OUT_NUM      (1)
#define AI_GENDER_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 2, 1, NULL), \
}
#define AI_GENDER_OUT_SIZE { \
  (1 * 1 * 2), \
}
#define AI_GENDER_OUT_1_SIZE  (1 * 1 * 2)
#define AI_GENDER_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 1)

#define AI_GENDER_N_NODES (10)
 ...
 * @ref ai_gender_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_GENDER_*
 * defines into file @ref gender.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_gender_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_GENDER_H__*/
